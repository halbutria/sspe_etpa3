    ...
    public partial class _121 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacanteTipoPoblacion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VacanteTipoPoblacion_Vacante_VacanteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VacanteTipoPoblacion_VacanteId",
