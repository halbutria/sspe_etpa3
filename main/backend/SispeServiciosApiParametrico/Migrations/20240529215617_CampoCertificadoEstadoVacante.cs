...
{
    public partial class CampoCertificadoEstadoVacante : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CampoCertificadoEstadoVacantes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampoCertificadoEstadoVacantes", x => x.Id);
                });
        }
