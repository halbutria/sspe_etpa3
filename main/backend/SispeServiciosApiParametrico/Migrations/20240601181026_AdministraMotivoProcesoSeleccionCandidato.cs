...
{
    public partial class AdministraMotivoProcesoSeleccionCandidato : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AdministraMotivoProcesoSeleccionCandidatos",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdministraMotivoProcesoSeleccionCandidatos", x => x.Id);
                });
        }
