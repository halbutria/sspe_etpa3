...
{
    public partial class ParametrizaOfertaModoAsistencia : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ParametrizaOfertaModoAsistencia",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParametrizaOfertaModoAsistencia", x => x.Id);
                });
        }
