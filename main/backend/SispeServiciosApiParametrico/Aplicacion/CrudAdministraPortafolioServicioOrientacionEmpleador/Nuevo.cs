    ...
    public class Nuevo
    {
        ...
        public class Manejador : IRequestHandler<Ejecuta, ParametricoDTO>
        {
            ...
            public async Task<ParametricoDTO> Handle(Ejecuta request, CancellationToken cancellationToken)
            {
                ...
                var info = new Modelo.AdministraPortafolioServicioOrientacionEmpleador();
                info.Nombre = request.Nombre;
                info.Descripcion = request.Descripcion;

                _contexto.AdministraPortafolioServicioOrientacionEmpleador.Add(info);
                ...
                throw new Exception("Error al guardar la administración del portafolio de servicio de orientación ocupacional del empleador");
            }
        }
    }
}
