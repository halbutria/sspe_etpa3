    ...
    public class Nuevo
    {
        ...
        public class Manejador : IRequestHandler<Ejecuta, ParametricoDTO>
        {
            ...
            public async Task<ParametricoDTO> Handle(Ejecuta request, CancellationToken cancellationToken)
            {
                ...
                var info = new Modelo.TipoDocumento();
                //_mapper.Map(request, info, typeof(Ejecuta), typeof(Modelo.TipoDocumento));
                //var info = _mapper.Map<Ejecuta, Modelo.TipoDocumento>(request);
                info.Nombre = request.Nombre;
                info.Sigla = request.Sigla;
                info.Principal = (bool)request.Principal;

                _contexto.tipoDocumento.Add(info);
