...
namespace SispeServicios.Api.Parametrico.Aplicacion.CrudIndicadorSatisfaccionDiligenciamiento
{
    public class Edicion
    {
        ...
        public class Manejador : IRequestHandler<Ejecuta, ParametricoDTO>
        {
            ...
            {
                var info = await _contexto.IndicadorSatisfaccionDiligenciamiento.FindAsync(Int32.Parse(request.Id));
                ...
                if (info is not null)
                {
                    ...
                    _contexto.IndicadorSatisfaccionDiligenciamiento.Update(info);

                    await _contexto.SaveChangesAsync();

                    return _mapper.Map<IndicadorSatisfaccionDiligenciamiento, ParametricoDTO>(info);
